...
from .models import Pregunta,ElegirRespuesta,PreguntasRespondidas, Proceso,QuizUsuario, CampanaAsignada,Empresa,tipo_usuario,Empresa
...
class ProfileRegisterForm(forms.ModelForm):
    class Meta:
        model = tipo_usuario
        fields = ['empresa', 'image', 'cargo','tipo_de_usuario'] 
...
class preguntaquizform(forms.ModelForm):
    class Meta:
        ...
        fields = ["proceso",'max_puntaje','texto',"archivo"]
...
class AddEmpresa(forms.ModelForm):
    usuarios = forms.CharField(required=False)
